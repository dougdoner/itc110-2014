    ...
    class Program
    {
        ...
        private void FillGrades()
        {
            ...
            for (int i = 0; i < gradeNumber; i++)
            {
                ...
                currentGrades[i] = inputLoop("Enter a grade for this class", currentGrades[i]);
                /* do
                {
                ...
                currentCredits[i] = inputLoop("Enter the credits for this class", currentCredits[i]);
            }
        ...
        /* incorrect way
        private double inputLoop(string description, double arrayValue)
        {
            double goodArrayValue = 0;
            do
            {
                Console.WriteLine(description);
                bool goodNumTwo = double.TryParse(Console.ReadLine(), out arrayValue);
                goodArrayValue = arrayValue;
            } while (!goodNumber);
            Console.WriteLine(arrayValue);
            return arrayValue = goodArrayValue;
        } */
        ...
        private double inputLoop(string description, double arrayValue)
        {
            ...
            {
                Console.WriteLine(description);
                goodNumTwo = double.TryParse(Console.ReadLine(), out arrayValue);
            } while (!goodNumTwo);
